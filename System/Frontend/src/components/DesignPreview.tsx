export default function DesignPreview() {
  return (
    <div className="min-h-screen bg-agt-base text-agt-text font-agt-sans p-agt-8">
      <h1 className="text-agt-h1 text-agt-heading mb-agt-10">Design System Preview</h1>

      {/* ── Color Palette ───────────────────────────── */}
      <section className="mb-agt-12">
        <h2 className="text-agt-h3 text-agt-heading mb-agt-6">Color Palette</h2>
      ...
      {/* ── Typography Scale ─────────────────────────── */}
      <section className="mb-agt-12">
        <h2 className="text-agt-h3 text-agt-heading mb-agt-6">Typography Scale</h2>
        <div className="bg-agt-surface rounded-agt-lg p-agt-8 flex flex-col gap-agt-4">
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">h1 · 2.25rem · bold</span>
            <p className="text-agt-h1 text-agt-heading font-bold leading-none">The quick brown fox</p>
          </div>
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">h2 · 1.75rem · bold</span>
            <p className="text-agt-h2 text-agt-heading font-bold leading-none">The quick brown fox</p>
          </div>
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">h3 · 1.375rem · bold</span>
            <p className="text-agt-h3 text-agt-heading font-bold leading-none">The quick brown fox</p>
          </div>
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">h4 · 1.125rem · medium</span>
            <p className="text-agt-h4 text-agt-heading font-medium leading-none">The quick brown fox</p>
          </div>
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">h5 · 1rem · medium</span>
            <p className="text-agt-h5 text-agt-heading font-medium leading-none">The quick brown fox</p>
          </div>
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">h6 · 0.875rem · medium</span>
            <p className="text-agt-h6 text-agt-heading font-medium leading-none">The quick brown fox</p>
          </div>
          <hr className="border-agt-border" />
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">body · 1rem · regular</span>
            <p className="text-agt-body text-agt-text">The quick brown fox jumps over the lazy dog.</p>
          </div>
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">sm · 0.875rem · regular</span>
            <p className="text-agt-sm text-agt-text-muted">The quick brown fox jumps over the lazy dog.</p>
          </div>
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">xs · 0.75rem · regular</span>
            <p className="text-agt-xs text-agt-text-muted">The quick brown fox jumps over the lazy dog.</p>
          </div>
          <div>
            <span className="text-agt-xs text-agt-text-muted font-agt-mono mr-agt-3">mono · 0.875rem</span>
      ...
      {/* ── Button Variants ──────────────────────────── */}
      <section className="mb-agt-12">
        <h2 className="text-agt-h3 text-agt-heading mb-agt-6">Button Variants</h2>
        <div className="bg-agt-surface rounded-agt-lg p-agt-8 flex flex-col gap-agt-6">
          <Row label="Primary">
      ...
      {/* ── Inputs ───────────────────────────────────── */}
      <section className="mb-agt-12">
        <h2 className="text-agt-h3 text-agt-heading mb-agt-6">Inputs</h2>
        <div className="bg-agt-surface rounded-agt-lg p-agt-8 flex flex-col gap-agt-5 max-w-lg">
          <div>
      ...
      {/* ── Semantic States ──────────────────────────── */}
      <section className="mb-agt-12">
        <h2 className="text-agt-h3 text-agt-heading mb-agt-6">Semantic States</h2>
...
function Row({ label, children }: { label: string; children: React.ReactNode }) {
  return (
    <div className="flex items-center gap-agt-4">
      <span className="text-agt-xs text-agt-text-muted font-agt-mono w-20 shrink-0">{label}</span>
